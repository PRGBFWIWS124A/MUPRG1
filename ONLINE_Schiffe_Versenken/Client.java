 ...
 * *
 * <p>
 * * Materialien zu den zentralen NRW-Abiturpruefungen im Fach Informatik ab
 * 2018 *
 * </p>
 * *
 * <p>
 ...
 * * diesem empfangen werden, wobei der Nachrichtenempfang nebenlaeufig
 * geschieht. * Zur Vereinfachung finden Nachrichtenversand und -empfang
 * zeilenweise statt, * d. h., beim Senden einer Zeichenkette wird ein
 * Zeilentrenner ergaenzt und beim * Empfang wird dieser entfernt. Jede
 * empfangene Nachricht wird einer * Ereignisbehandlungsmethode uebergeben, die
 * in Unterklassen implementiert werden * muss. Es findet nur eine rudimentaere
 * Fehlerbehandlung statt, so dass z.B. * Verbindungsabbrueche nicht zu einem
 * Programmabbruch fuehren. Eine einmal * unterbrochene oder getrennte
 * Verbindung kann nicht reaktiviert werden. *
 * </p>
 * * * @author Qualitaets- und UnterstuetzungsAgentur - Landesinstitut fuer
 * Schule * @version 30.08.2016
 */
            ...
            public void close() {
                if (socket != null)
                    try {
                        ...
                        /*
                         * * Falls eine Verbindung getrennt werden soll, deren Endpunkt * nicht mehr
                         * existiert bzw. ihrerseits bereits beendet worden ist, * geschieht nichts.
                         */ }
            }
        }
